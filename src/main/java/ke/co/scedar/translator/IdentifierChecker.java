...
import ke.co.scedar.translator.exceptions.FunctionIdentifierException;
import ke.co.scedar.translator.exceptions.SpecialIdentifierException;
...
public class IdentifierChecker {
    ...
    private static boolean isAliasToken(TSourceToken token) {
        ...
        return dbObjType == TObjectName.ttobjColumnAlias
